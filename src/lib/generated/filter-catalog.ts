...
export const FILTER_CATALOG: CatalogFilter[] = [
  {
    "jsonId": "annual-revenue",
    "id": "annualRevenue",
    "name": "Annual revenue",
    "type": "ranges",
    ...
    "options": [
      ...
      {
        "label": "$10M - $25M",
        "value": "10000000-24999999"
      },
      {
        "label": "$1B - $5B",
        "value": "1000000000-4999999999"
      },
      {
        "label": "$1M - $5M",
      ...
      {
        "label": "$25M - $50M",
        "value": "25000000-49999999"
      },
      {
        "label": "$500M - $1B",
        "value": "500000000-999999999"
      },
      {
        "label": "$50M - $100M",
        "value": "50000000-99999999"
      },
      {
        "label": "$5B - $10B",
        "value": "5000000000-9999999999"
      },
      {
        "label": "$5M - $10M",
  ...
  },
  {
    ...
    "options": [
      {
        "label": "Amazon",
        "value": "b4e53e29-32e5-7d82-642b-8e054bec6b67"
      },
      {
        "label": "Apple",
        "value": "abce3ed0-6732-bc57-6732-e1801358b811"
      },
      {
        "label": "Microsoft",
        "value": "76b8453e-6a29-538f-90b1-ec2d99ae630a"
      },
      {
        "label": "Sendr",
        "value": "c3c8070d-1ba5-208c-6c14-ea90adda3566"
      }
    ],
    "subFilters": []
  },
    ...
    "subFilters": [
      {
        ...
        "name": "Bulk domains",
        "formFields": [
          "companyDomainBulkInclude",
          "companyDomainBulkExclude"
        ],
        "options": [],
        "fields": [],
        "maxItems": 100,
      ...
      },
      {
        ...
        "formFields": [
          "companyDomainInclude",
          "companyDomainExclude"
        ],
        "options": [
          {
            "label": "Amazon",
    ...
    "subFilters": [
      {
        ...
        "name": "Degree",
        "formFields": [
          "educationDegreeInclude",
          "educationDegreeExclude"
        ],
        "options": [
          {
          ...
          {
            "label": "Associate of Engineering",
            "value": "Associate of Engineering"
          },
          {
          ...
          {
            "label": "Bachelor of Health Science",
            "value": "Bachelor of Health Science"
          },
          {
          ...
          },
          {
            ...
            "value": "Bachelor of Liberal Arts"
          },
          {
            "label": "Bachelor of Management Studies",
          ...
          },
          {
            ...
            "value": "Doctor of Ministry"
          },
          {
            "label": "Doctor of Nursing Practice",
            "value": "Doctor of Nursing Practice"
          },
          {
          ...
          },
          {
            ...
            "value": "Doctor of Osteopathic Medicine"
          },
          {
          ...
          },
          {
            ...
            "value": "Doctor of Psychology"
          },
          {
            "label": "Doctor of Public Health",
            "value": "Doctor of Public Health"
          },
          {
            "label": "Doctor of Social Work",
            "value": "Doctor of Social Work"
          },
          {
          ...
          {
            "label": "Higher National Certificate",
            "value": "Higher National Certificate"
          },
          {
      ...
      },
      {
        ...
        "name": "Field of study",
        "formFields": [
          "educationFieldOfStudyInclude",
          "educationFieldOfStudyExclude"
        ],
        "options": [
          {
            "label": "Accounting",
      ...
      },
      {
        ...
        "name": "School",
        "formFields": [
          "educationSchoolInclude",
          "educationSchoolExclude"
        ],
        "options": [],
        "fields": [],
        "maxItems": null,
  ...
  {
    "jsonId": "employees-by-department",
      ...
      },
      {
        ...
        "options": [
          ...
          },
          {
            ...
            "value": "community_and_social_services"
          },
          {
            "label": "Consulting",
            "value": "consulting"
          },
          {
            ...
            "value": "customer_success_and_support"
          },
          {
            "label": "Education",
            "value": "education"
          ...
          },
          {
            ...
            "value": "program_and_project_management"
          },
          {
            "label": "Purchasing",
            "value": "purchasing"
  ...
  },
  {
    ...
    "formFields": [
      "industryInclude",
      "industryExclude",
      "personIndustryInclude",
      "personIndustryExclude"
    ],
    "options": [
      {
        "label": "3d Printing",
      ...
      {
        "label": "Audio Recording and Production",
        "value": "audio recording and production"
      },
      {
      ...
      },
      {
        ...
        "value": "business process automation (bpa)"
      },
      {
      ...
      {
        "label": "Data Collection and Labeling",
      ...
      },
      {
        ...
        "value": "foreign exchange trading"
      },
      {
        "label": "Forestry",
        "value": "forestry"
      ...
      {
        "label": "Sports Leagues and Teams",
        "value": "sports leagues and teams"
      },
      {
  ...
  },
  {
    ...
    "options": [
      ...
      },
      {
        ...
        "value": "People Operations Manager"
      },
      {
    ...
    "subFilters": [
      {
        "id": "primary-active-role-only",
        "name": "Primary active role only",
        "formFields": [],
        "options": [],
        "fields": [],
        "maxItems": null,
    ...
    "subFilters": [
      {
        ...
        "options": [
          ...
          },
          {
            ...
            "value": "WORK_HISTORY_DESCRIPTION"
          }
        ],
        "fields": [],
        "maxItems": null,
    ...
    "subFilters": [
      {
        ...
        "name": "Company",
        "formFields": [
          "companyLanguageInclude",
          "companyLanguageExclude"
        ],
        "options": [
          {
            "label": "Albanian",
  ...
  {
    "jsonId": "linkedin-profile-badge",
    "id": "linkedInBadge",
    "name": "LinkedIn profile badge",
    "type": "preset-list",
    "supportsIncludeExclude": true,
    "allowCustomValues": false,
    "formFields": [
    ...
    "options": [
      ...
      {
        "label": "Paid social members",
        "value": "PAID_SOCIAL_MEMBERS"
      },
      {
        "label": "Verified",
        "value": "VERIFIED"
    ...
    "subFilters": [
      {
        ...
        "name": "Company page URL",
        "formFields": [
          "companyLinkedInUrlInclude",
          "companyLinkedInUrlExclude"
        ],
        "options": [],
        "fields": [],
        "maxItems": 100,
  ...
  },
  {
    ...
    "allowCustomValues": true,
    "formFields": [
      "productAndServicesInclude",
      "productAndServicesExclude"
    ],
    "options": [
      {
        "label": "Advertising",
...
export const FILTER_ORDER: string[] = ["annualRevenue","certifications","companyName","companyType","domain","education","employees","employeesDepartment","foundedYear","funding","headcountGrowth","industry","jobTitle","keywords","languages","linkedInBadge","linkedInUrl","location","personName","productsServices","seniority","skills","socialMedia","technology"];
